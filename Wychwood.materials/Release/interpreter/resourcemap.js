...
StaticImageInfo = {
  ...
  3: {
     "image": 3, 
     "url": "Cover.jpg",
     "alttext": "A low-resolution black-and-white 1-bit image from the original game. An open concrete and wrought-iron gate leads to a lifted slab in front of a gothic mansion. Above it all is the title in a bat shape, reading Wychwood.",
     "width": 543,
     "height": 543
   }
